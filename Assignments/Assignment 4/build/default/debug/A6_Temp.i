...
_start1:
   MOVLW 0
   MOVWF TRISD
   MOVLW 15 ; this is the input value ;sets refTemp
   MOVWF 0x20
   MOVLW -5 ; this is the input value ;sets measuedTemp
   MOVWF 0x21
...
Continue:
   ...
   HexToDec: ;Converts Hex to Dec
     ...
     MOVWF 0x1
     MOVLW 100
   A1: INCF 0x2, F ;A1 loop converts the 100s place of ref to dec
     SUBWF 0x1, F
     BC A1
     DECF 0x2, F
     ADDWF 0x1, F
     ...
     CLRF 0x2
     MOVLW 10
   B1: INCF 0x2, F ;B1 loop converts the 10s place of ref to dec
     SUBWF 0x1, F
     BC B1
     DECF 0x2, F
     ADDWF 0x1, F
     MOVFF 0x2, 0x61
     MOVFF 0x1, 0x60 ;Places 1s place of ref in Reg60

     CLRF 0x2
     MOVLW -5 ; this is the input value
     MOVWF 0x1
     MOVLW 100
   A2: INCF 0x2, F ;A2 loop converts the 100s place of measured to dec
     SUBWF 0x1, F
     BC A2
     DECF 0x2, F
     ADDWF 0x1, F
     ...
     CLRF 0x2
     MOVLW 10
   B2: INCF 0x2, F ;B2 loop converts the 10s place of measured to dec
     SUBWF 0x1, F
     BC B2
     DECF 0x2, F
     ADDWF 0x1, F
     MOVFF 0x2, 0x71
     MOVFF 0x1, 0x70 ;Places 1s place of measured in Reg62
     GOTO Continue
