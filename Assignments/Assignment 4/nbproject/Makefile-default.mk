...
SOURCEFILES_QUOTED_IF_SPACED=A6_Temp.asm

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/A6_Temp.o
POSSIBLE_DEPFILES=${OBJECTDIR}/A6_Temp.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/A6_Temp.o

# Source Files
SOURCEFILES=A6_Temp.asm
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/A6_Temp.o: A6_Temp.asm  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/A6_Temp.o 
	${MP_AS} -mcpu=PIC18F46K42 -c \
	-o ${OBJECTDIR}/A6_Temp.o \
	A6_Temp.asm \
