...
_main:
    ;PortB=1 count up, thus ((PORTB) and 0FFh), 0, a=1
    ;PORTB=2 count down, thus ((PORTB) and 0FFh), 1, a=1

    ;initialize ((NVMCON1) and 0FFh), 6, b-F with values here
    MOVLW 0x3F ;0
    MOVWF 0x00
    MOVLW 0x06 ;1
    MOVWF 0x01
...
_setupPortD:
    ...
    BANKSEL TRISD ;
    MOVLW 0b00000000 ;Set ((NVMCON1) and 0FFh), 0, b[7:0] as outputs
    MOVWF TRISD
    RETURN
...
_setupPortB:
    ...
    BANKSEL TRISB ;
    MOVLW 0b11111111 ;Set ((NVMCON1) and 0FFh), 0, b[7:0] as inputs
    MOVWF TRISB
    RETURN
